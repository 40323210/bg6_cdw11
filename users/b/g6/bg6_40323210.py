...
bg6_40323210 = Blueprint('bg6_40323210', __name__, url_prefix='/bg6_40323210', template_folder='templates')
...
@bg6_40323210.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg6_40323210.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg6_40323210.route('/circle36/<x>/<y>/<degree>')

def drawcircle36(x, y, degree):
    return head_str + chain_str + circle36(int(x), int(y), int(degree)) + tail_str
    
#@bg6_40323210.route('/circle36/<int:x>/<int:y>/<int:degree>')
...
@bg6_40323210.route('/circle35/<x>/<y>/<degree>/<a>/<b>/<degree2>')
...
@bg6_40323210.route('/a')
def draw_a():
    return head_str + chain_str + a(0, 0) + tail_str
@bg6_40323210.route('/task10_1')
def task10_1():
    outstring = '''
<!DOCTYPE html>
<html>
