...
bg6_40323210_2 = Blueprint('bg6_40323210_2', __name__, url_prefix='/bg6_40323210_2', template_folder='templates')
...
'''
    ...
    return outstring
@bg6_40323210_2.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg6_40323210_2.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg6_40323210_2.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg6_40323210_2.route('/circle1/<x>/<y>/<degree>')
#@bg6_40323210_2.route('/circle1/<int:x>/<int:y>/<int:degree>')
...
@bg6_40323210_2.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg6_40323210_2.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg6_40323210_2.route('/circle2/<x>/<y>/<degree>')
#@bg6_40323210_2.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@bg6_40323210_2.route('/twocircle/<x>/<y>')
@bg6_40323210_2.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg6_40323210_2.route('/eighteenthirty/<x>/<y>')
@bg6_40323210_2.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg6_40323210_2.route('/snap')
...
@bg6_40323210_2.route('/snap_link')
...
@bg6_40323210_2.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
